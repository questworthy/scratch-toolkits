...
<div class="max-w-screen-sm mx-auto">
	<SvelteMarkdown
		source={`
The Scratch story about Rani and Aryan in Step 1 talked about so many scenarios. Here we shall reflect on some of the concepts you saw.
