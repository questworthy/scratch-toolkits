...
>
	<div
		class="{base
			? 'bg-[#F682A5] group-hover:bg-[#F9A474]'
			: 'bg-[#C3B2E7] group-hover:bg-[#C9D990]'} rounded-2xl h-full w-full absolute left-2 top-2 -z-10 group-hover:-translate-x-2 group-hover:-translate-y-2 transition-all duration-200"
	></div>
	{label}
</button>
